...
class CategoryViewFolder(view:View):RecyclerView.ViewHolder(view) {

    private  val tvCategoryName: TextView = view.findViewById(R.id.tvCategoryName)
    private  val divider: View = view.findViewById(R.id.divider)
    private val vConteiner: CardView = view.findViewById(R.id.vConteiner)
    fun render(taskCategory: TaskCategory, onItemSelected: (Int) -> Unit){
        ...
        vConteiner.setCardBackgroundColor(ContextCompat.getColor(vConteiner.context,color))
